...
public class MathUtilDDTTest {
    //hàm nảy ta sẽ trả về mảng 2 chiểu gồm nhiểu cặp Expected|Input
    ...
    //giả sử loop qua từng dòng của mảng, ta vẩn cần gán từng value của cột
    //vào biến tương ứng input, expected để lát hồi feed cho hàm
    @Parameterized.Parameter(value = 0)     //value = 0 là map vs mảng data
    public int n;   //biến map vs value của cột 0 của mảng
